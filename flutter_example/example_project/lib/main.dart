...
class FavoriteState {
  ...
  FavoriteState({required this.isFavorited, required this.favoriteCount});

  FavoriteState copyWith({bool? isFavorited, int? favoriteCount}) {
...
class FavoriteCubit extends Cubit<FavoriteState> {
  FavoriteCubit() : super(FavoriteState(isFavorited: true, favoriteCount: 41));

  void toggleFavourite() {
    final currentState = state;
    final newIsFavorited = !currentState.isFavorited;
    final newFavoriteCount = newIsFavorited
        ? currentState.favoriteCount + 1
        : currentState.favoriteCount - 1;

    emit(currentState.copyWith(
        isFavorited: newIsFavorited, favoriteCount: newFavoriteCount));
  }
}
      ...
      builder: (context, state) {
        return Row(
          ...
          children: [
            ...
            SizedBox(
              width: 18,
              child: SizedBox(child: Text('${state.favoriteCount}')),
            ),
          ],
        );
      },
